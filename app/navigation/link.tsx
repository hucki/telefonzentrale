    ...
    <NavLink
      className={({ isActive, isPending, isTransitioning }) => {
        const color = isActive
          ? "bg-orange-200 dark:bg-orange-700 hover:bg-orange-300 dark:hover:bg-orange-600 focus:ring-orange-500"
          : isPending
          ? "bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-800 focus:ring-blue-500"
          : isTransitioning
          ? "bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-800 focus:ring-blue-500"
          : "bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-800 focus:ring-blue-500";
